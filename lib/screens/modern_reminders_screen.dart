...
class _ModernRemindersScreenState extends State<ModernRemindersScreen>
  ...
  List<SimpleReminder> _getRemindersForDay(DateTime day) {
    return _reminders.where((reminder) {
      ...
      // Check if reminder should be active on this day
      final dayOfWeek = day.weekday - 1; // Convert to 0-6
      if (dayOfWeek >= 0 && dayOfWeek < reminder.weekdays.length) {
        return reminder.weekdays[dayOfWeek];
      }
      return false;
    }).toList();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF4A90A4).withOpacity(0.1),
  ...
  void _saveReminder() {
    if (_formKey.currentState!.validate()) {
      ...
      final reminder = SimpleReminder(
        ...
        time: _reminderTimes.isNotEmpty ? _reminderTimes.first.format(context) : '08:00',
        isActive: true,
